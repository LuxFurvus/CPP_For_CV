    ...
    TEST(SortedRollsMakerTests, GetRoll_ReturnsEmpty_WhenDiceNumberIsNegative)
{
    ...
    const std::vector<int> Result
        = SortedRollsMaker::GetSortedRoll(-1, 6);
...
{
    EXPECT_TRUE(SortedRollsMaker::GetSortedRoll(3, 1).empty());
    EXPECT_TRUE(SortedRollsMaker::GetSortedRoll(3, 0).empty());
    EXPECT_TRUE(SortedRollsMaker::GetSortedRoll(3, -5).empty());
}
...
const std::vector<int> Result
    = SortedRollsMaker::GetSortedRoll(0, 6);
...
const std::vector<int> Result
    = SortedRollsMaker::GetSortedRoll(DiceNumber, SideNumber);
...
const std::vector<int> Result
    = SortedRollsMaker::GetSortedRoll(-10, 1);

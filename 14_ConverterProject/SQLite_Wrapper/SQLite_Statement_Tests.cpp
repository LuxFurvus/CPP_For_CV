...
TEST(SQLite_Statement, T01_MoveConstructorFromValid)
{
    ...
    SQLite_StatementCreationKit Kit{ Sentinel, Db };
...
TEST(SQLite_Statement, T08_MoveWithAndWithoutSentinel)
{
    ...
    SQLite_StatementCreationKit WithSentinel{ std::make_shared<SQLite_StatementSentinel>(), Db };
    SQLite_StatementCreationKit NoSentinel{ std::weak_ptr<SQLite_StatementSentinel>(), Db };
